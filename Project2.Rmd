...
* Q19: The plot shows a fitted GAM, where for each plot all but the displayed variable are held constant to show how the variable affect the response, in this case miles per gallon (mpg). Starting from the upper left corner:
