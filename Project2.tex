...
\item
  ...
  \(BIC=\frac{1}{n}(RSS+\mathrm{log}(n)k\hat \sigma^2)\) for each, where
...
\item
  ...
  coefficients such as \texttt{weight} difficult to see exactly for
  which value of \(\lambda\) they become zero, as they have small
  values.
\end{itemize}
